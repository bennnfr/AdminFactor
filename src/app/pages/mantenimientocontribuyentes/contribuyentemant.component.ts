...
export class ContribuyenteMantComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._mantenimientocontservice.getEscrituras( this.idc ).subscribe( resp => {this.escrituras = resp; console.log(this.escrituras); } );
    this._mantenimientocontservice.getFirmantes(this.idc).subscribe( resp => {this.firmantes = resp;
                                                                             // console.log(this.escrituras);
...
// DOMICILIOS ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  modificardireccion() {
    ...
    this._mantenimientocontservice.modificaDireccion(this.idc, valordireccion , params).subscribe( resp => { console.log(resp);
                                                                                                             swal2.fire({
...
'error'
  ...
  registrardireccionp() {
    ...
    this._contribuyentesservice.creaDireccionxContribuyente(this.idc, params).subscribe( resp => { console.log(resp);
                                                                                                   swal2.fire(
...
validaCurp() {
  ...
  registrarcontribuyentemoral() {
    ...
    this._mantenimientocontservice.actualizaLegalEntity(idm, datapm).subscribe( resp => { console.log(resp);
  ...
  registrarcontribuyentefisica() {
    ...
    this._mantenimientocontservice.actualizaPerson(idm, paramspf).subscribe( resp => { console.log(resp);
                                                                                       this._mantenimientocontservice.actualizaContribuyente(this.idc, contribuyentepf).subscribe( () => {
                                                                                            swal2.fire(
                                                                                            'Los datos se modificaron con exito',
                                                                                            '',
                                                                                            'success'
  ...
  getescritura() {
    ...
    this._mantenimientocontservice.getEscritura( this.idc, ide ).subscribe( resp => {this.escritura = resp; console.log(this.escritura); } );
  } else {
    this.escritura = [];
  }
  }
...
'error'
  ...
  guardaEscritura() {
    ...
    this._contribuyentesservice.crearDP(this.idc, params).subscribe( resp => { console.log(resp);
                                                                               this.iddp = resp;
                                                                               swal2.fire(
                                                                    'Los datos se guardaron con exito',
                                                                    '',
  ...
  modificaEscritura( ide ) {
    ...
    this._mantenimientocontservice.modificaEscritura(this.idc, ide , params).subscribe( resp => { console.log(resp);
                                                                                                  swal2.fire({
        title: 'Los datos se modificaron',
        text: 'Con exito',
        icon: 'success',
...
'error'
  ...
  agregaFirmante() {
    ...
    this._contribuyentesservice.creaFirmantexContribuyente(this.idc, params).subscribe( resp => { console.log(resp);
                                                                                                  swal2.fire(
'Los datos se guardaron con exito',
'',
'success'
...
'error'
  ...
  //  console.log(this.escrituras);
    console.log(params);
    console.log(this.idc);
    console.log(valorfirmantes);

    this._mantenimientocontservice.actualizaFirmante( this.idc, valorfirmantes, params ).subscribe( resp => { console.log(resp);
      swal2.fire(
'Los datos se guardaron con exito',
'',
'success'
