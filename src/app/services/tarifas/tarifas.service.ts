...
export class TarifasService {
    ...
    getTarifas() {
      ...
      const url = `${URL_SERVICIOS}/rates?token=${this.token}&secret_key=${SECRET_KEY}`;
    ...
    modificaTarifa( id ) {
      ...
      const url = `${URL_SERVICIOS}/rates/${id}?token=${this.token}&secret_key=${SECRET_KEY}`;
    ...
    const url = `${URL_SERVICIOS}/rates/${id}`;
    ...
    getRatetype() {
      ...
      const url = `${URL_SERVICIOS}/lists/domain/RATE_TYPE?token=${this.token}&secret_key=${SECRET_KEY}`;
