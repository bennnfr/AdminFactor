...
export class ParametrosGeneralesService {
  ...
  getParametros() {
    ...
    const url = `${ URL_SERVICIOS }/general_parameters?token=${ this.token }&secret_key=${ SECRET_KEY }`;
...
getParametro( id: string ) {
  ...
  const url = `${URL_SERVICIOS}/general_parameters/${id}?token=${this.token}&secret_key=${SECRET_KEY}`;
...
const url = `${URL_SERVICIOS}/general_parameters/${idp}?token=${this.token}&secret_key=${SECRET_KEY}&general_parameter[description]=${Descripcion}&general_parameter[key]=${Key}&general_parameter[value]=${Valor}&general_parameter[table]=${Tabla}&general_parameter[id_table]=${IdTabla}&general_parameter[used_values]=${UsedValues}&general_parameter[documentation]=${Documentacion}`;
