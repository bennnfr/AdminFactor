...
export class PrivilegiosUsuariosService {
    ...
    getPrivilegiosUsuario( id: string ) {
        ...
        const url = `${URL_SERVICIOS}/users/${id}/user_privileges?secret_key=${SECRET_KEY}&token=${this.token}`;
 ...
 // console.log(usuariosObj);
    ...
    guardarPrivilegio( id: string, forma: Privilegio ) {
      ...
      const url = `${URL_SERVICIOS}/users/${id}/user_privileges?user_privilege[description]=${ forma.descripcion }&user_privilege[key]=${ forma.key }&user_privilege[value]=${ forma.valor }&user_privilege[documentation]=${ forma.documentacion }&secret_key=${ SECRET_KEY }&token=${ this.token }`;
    ...
    borraPrivilegio(privilegioid: string, usuarioid: string) {
      ...
      const url = `${URL_SERVICIOS}/users/${ usuarioid }/user_privileges/${ privilegioid }?secret_key=${ SECRET_KEY }&token=${ this.token }`;
    ...
    getPrivilegio( idu: string, idp: string ) {
      ...
      const url = `${ URL_SERVICIOS }/users/${ idu }/user_privileges/${ idp }?secret_key=${ SECRET_KEY }&token=${ this.token }`;
...
// console.log(usuariosObj);
  ...
  actualizaPrivilegio(idu: string, idp: string,  pri: Privilegio) {
    ...
    const url = `${ URL_SERVICIOS }/users/${ idu }/user_privileges/${ idp }?secret_key=${ SECRET_KEY }&token=${ this.token }&user_privilege[description]=${ pri.descripcion }&user_privilege[key]=${ pri.key }&user_privilege[value]=${ pri.valor }&user_privilege[documentation]=${ pri.documentacion }`;
